...
export const routes: Routes = [
	{ path: 'primary-layout-one', component: PrimaryLayoutOneComponent, canActivate: [AuthGuardService],
		children: [
			...
			{ path: 'secondary-layout-two', component: SecondaryLayoutTwoComponent, outlet: 'outlet2',
				children: [
					{ path: 'chart', component: BaseC3ChartComponent, outlet: 'outlet1', data: { exgStock: ['TDWL', '1090'] } },
				],
			},
			...
			{ path: 'secondary-layout-three', component: SecondaryLayoutThreeComponent, outlet: 'outlet2',
				children: [
					{ path: 'chart', component: BaseC3ChartComponent, outlet: 'outlet1', data: { exgStock: ['TDWL', '1090'] } },
					{ path: 'chart', component: BaseC3ChartComponent, outlet: 'outlet2', data: { exgStock: ['TDWL', '1010'] } },
					{ path: 'chart', component: BaseC3ChartComponent, outlet: 'outlet3', data: { exgStock: ['CASE', 'OTMT'] } },
					{ path: 'chart', component: BaseC3ChartComponent, outlet: 'outlet4', data: { exgStock: ['DFM', 'EMAAR'] } },
					{ path: 'chart', component: BaseC3ChartComponent, outlet: 'outlet5', data: { exgStock: ['CASE', 'OTMT'] } },
				],
			},
	...
	{ path: 'mutual-fund-detail-layout', component: MutualFundDetailLayoutComponent,
		children: [
			...
			{ path: 'mutual-fund-detail-performance', component: MutualFundDetailPerformanceComponent, outlet: 'outlet2' },
			{ path: 'mutual-fund-benchmark', component: MutualFundBenchmarkComponent, outlet: 'outlet3' },
			{ path: 'mutual-fund-report', component: MutualFundReportComponent, outlet: 'outlet4' },
		],
	},
];
